...
public class MonticuloBinario {
    private Documento[] nodos = new Documento[100];
...
//aumentar prioridad
    ...
    private void hundir(int i) {
        ...
        if (izq < tamaño && nodos[izq].getEtiquetaTiempo() < nodos[menor].getEtiquetaTiempo()) menor = izq;
        if (der < tamaño && nodos[der].getEtiquetaTiempo() < nodos[menor].getEtiquetaTiempo()) menor = der;
        if (menor != i) {
    ...
    public Documento[] getArreglo() { return nodos; }
}
